...
@Properties({
        ...
        @Property(name = "osgi.command.function", value = {"adduser", "addtask", "gettasks", "finduser", "assigntask", "init", "initAll"})
})
public class ABServiceConsoleImpl implements ABServiceConsole {
    ...
    @Reference(cardinality = ReferenceCardinality.OPTIONAL_UNARY, policy = ReferencePolicy.DYNAMIC, name = "ProjectServiceRef")
    private volatile ProjectService projectService;

    @Reference(cardinality = ReferenceCardinality.OPTIONAL_UNARY, policy = ReferencePolicy.DYNAMIC, name = "LoggingServiceRef")
    private volatile LoggingService loggingService;

    @Reference(cardinality = ReferenceCardinality.OPTIONAL_UNARY, policy = ReferencePolicy.DYNAMIC, name = "StorageServiceRef")
