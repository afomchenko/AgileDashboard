...
import ru.mera.agileboard.model.impl.TaskPriorityImpl;
import ru.mera.agileboard.model.impl.TaskStatusImpl;
import ru.mera.agileboard.model.impl.TaskTagImpl;
import ru.mera.agileboard.model.impl.TaskTypeImpl;
 ...
 */
@Component(name = "ru.mera.agileboard.service.gogo.BTServiceProxyComponent", service = ABServiceConsole.class, properties = {
        "osgi.command.scope = bt",
        "osgi.command.function = {adduser, addtask, gettasks, finduser, assigntask, init, initAll"}, immediate = true)
public class ABServiceConsoleImpl implements ABServiceConsole {

    @Reference(cardinality = ReferenceCardinality.MANDATORY, policy = ReferencePolicy.DYNAMIC, name = "UserServiceRef")
    private volatile UserService userService;

    @Reference(cardinality = ReferenceCardinality.MANDATORY, policy = ReferencePolicy.DYNAMIC, name = "TasksServiceRef")
    private volatile TaskService taskService;

    @Reference(cardinality = ReferenceCardinality.MANDATORY, policy = ReferencePolicy.DYNAMIC, name = "ProjectServiceRef")
    private volatile ProjectService projectService;

    @Reference(cardinality = ReferenceCardinality.MANDATORY, policy = ReferencePolicy.DYNAMIC, name = "LoggingServiceRef")
    private volatile LoggingService loggingService;

    @Reference(cardinality = ReferenceCardinality.MANDATORY, policy = ReferencePolicy.DYNAMIC, name = "StorageServiceRef")
    ...
    public String initAll() {
        ...
        try {
            ...
            Task t2 = tb2.name("Second Task")
                    .description("This is description of second task. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.")
                    .priority(tp2)
                    .project(p1)
            ...
            Task t3 = tb3.name("Third Task")
                    .description("This is description of third task. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.")
                    .priority(tp2)
                    .project(p1)
            ...
            Task t4 = tb4.name("FourthTask")
                    .description("This is description of fourth task. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.")
                    .priority(tp2)
                    .project(p2)
            ...
            Task t6 = tb6.name("Sixth Task")
                    .description("This is description of sixth task. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.")
                    .priority(tp2)
                    .project(p2)
            ...
            Task t7 = tb7.name("Seventh Task")
                    .description("This is description of seventh task. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.")
                    .priority(tp2)
                    .project(p1)
            ...
            Task t8 = tb8.name("Eighth Task")
                    .description("This is description of eighth task. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.")
                    .priority(tp2)
                    .project(p2)
            ...
            TaskLog tl12 = new TaskLogImpl(t1, u2, 4, LocalDateTime.now()
                    .minus(4, ChronoUnit.DAYS)
                    .truncatedTo(ChronoUnit.DAYS)
                    .atZone(ZoneId.systemDefault())
                    .toEpochSecond() * 1000);
            TaskLog tl13 = new TaskLogImpl(t3, u2, 4, LocalDateTime.now()
                    .minus(4, ChronoUnit.DAYS)
                    .truncatedTo(ChronoUnit.DAYS)
                    .atZone(ZoneId.systemDefault())
                    .toEpochSecond() * 1000);
            ...
            TaskLog tl4 = new TaskLogImpl(t1, u5, 1, LocalDateTime.now()
                    .minus(1, ChronoUnit.DAYS)
                    .truncatedTo(ChronoUnit.DAYS)
                    .atZone(ZoneId.systemDefault())
                    .toEpochSecond() * 1000);
            TaskLog tl5 = new TaskLogImpl(t1, u5, 2, LocalDateTime.now()
                    .minus(2, ChronoUnit.DAYS)
                    .truncatedTo(ChronoUnit.DAYS)
                    .atZone(ZoneId.systemDefault())
                    .toEpochSecond() * 1000);
            TaskLog tl6 = new TaskLogImpl(t1, u5, 3, LocalDateTime.now()
                    .minus(3, ChronoUnit.DAYS)
                    .truncatedTo(ChronoUnit.DAYS)
                    .atZone(ZoneId.systemDefault())
                    .toEpochSecond() * 1000);
            TaskLog tl7 = new TaskLogImpl(t1, u5, 4, LocalDateTime.now()
                    .minus(4, ChronoUnit.DAYS)
                    .truncatedTo(ChronoUnit.DAYS)
                    .atZone(ZoneId.systemDefault())
                    .toEpochSecond() * 1000);
            TaskLog tl8 = new TaskLogImpl(t1, u5, 5, LocalDateTime.now()
                    .minus(5, ChronoUnit.DAYS)
                    .truncatedTo(ChronoUnit.DAYS)
                    .atZone(ZoneId.systemDefault())
                    .toEpochSecond() * 1000);
            TaskLog tl9 = new TaskLogImpl(t1, u5, 6, LocalDateTime.now()
                    .minus(6, ChronoUnit.DAYS)
                    .truncatedTo(ChronoUnit.DAYS)
                    .atZone(ZoneId.systemDefault())
                    .toEpochSecond() * 1000);
            TaskLog tl10 = new TaskLogImpl(t1, u5, 7, LocalDateTime.now()
                    .minus(7, ChronoUnit.DAYS)
                    .truncatedTo(ChronoUnit.DAYS)
                    .atZone(ZoneId.systemDefault())
                    .toEpochSecond() * 1000);
            TaskLog tl11 = new TaskLogImpl(t1, u5, 8, LocalDateTime.now()
            ...
            for (int i = 0; i < 100; i++) {
                ...
                Task t = tb.name("Task #" + i)
                        .description("This is description of task #" + i + ". Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.")
                        .priority(pr)
                        .project(p)
                        .testSteps("This is teststeps of task#" + i + ". Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.")
                        .type(tt)
                        .creator(u)
                        .estimated((int) (Math.random() * 32 + 1))
                        .build();
                t.setAssignee(a);
                t.setStatus(st);
                t.store();
                ...
                for (int j = 0; j < (int) (Math.random() * 15 + 1); j++) {
                    ...
                    if (t.getEstimated() >= (logged + log)) {
                        loggingService.createLog(t, commentor, log, LocalDateTime.now()
                                .minus((int) (Math.random() * 20 + 1), ChronoUnit.DAYS)
                                .truncatedTo(ChronoUnit.DAYS)
                                .atZone(ZoneId.systemDefault())
                                .toEpochSecond() * 1000);
                        logged += log;
