 ...
 */
@Component(name = "ru.mera.agileboard.service.TaskServiceComponent", service = TaskService.class, immediate = true)
public class TaskServiceImpl implements TaskService {
    ...
    @Reference(cardinality = ReferenceCardinality.MANDATORY, policy = ReferencePolicy.STATIC, name = "projectService")
    private volatile ProjectService projectService;
    @Reference(cardinality = ReferenceCardinality.MANDATORY, policy = ReferencePolicy.STATIC, name = "userSessionRef")
